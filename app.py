...
for mkr in map_markers:
    popup_html = f"""<div style="width: 450px; color: black !important;">
        <h4 style="color: #002366; border-bottom: 2px solid #002366; margin-bottom: 10px;">{mkr['iata']} Technical Data</h4>

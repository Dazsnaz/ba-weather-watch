...
# 2. HUD STYLING (V26.0 - TOTAL NAVY & CONTRAST LOCK)
st.markdown("""
    <style>
    ...
    /* STRATEGY BRIEF - PERMANENT NAVY LOCK */
    .reason-box { 
...
st_folium(m, width=1200, height=1200, key="map_v26")
